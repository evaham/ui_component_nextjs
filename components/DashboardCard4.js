    ...
    <div className="p-6 rounded-2xl bg-white transition-all">
      ...
      {type === "sales" ? (
        ...
        <div className="flex items-center -mt-2 mb-2">
          <div className="flex items-center gap-2">
            <div className="w-1.5 h-1.5 bg-[#26499d] rounded-full"></div>
            <span className="font-bold text-zinc-900 tracking-tight">어제 (7/30) 매출</span>
          </div>
          <button className="ml-4 text-sm text-zinc-600 font-medium cursor-pointer tracking-tighter">
            더보기
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="relative flex flex-col px-4 py-3 bg-[#26499d] rounded-2xl">
          <div className="text-sm font-semibold text-zinc-100 mb-2">우리 매출액</div>
        ...
        {/* 전국 200평 이하 */}
        <div className="relative flex flex-col px-4 py-3 border border-zinc-200 rounded-2xl text-zinc-600">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {/* 우리매장 */}
        <div className="relative flex flex-col px-4 py-3 border border-zinc-200 rounded-2xl text-zinc-600">
          <div className="text-sm font-semibold mb-2 tracking-tighter">우리 매출액</div>
          <div className="flex items-baseline gap-1 mb-1 font-bold text-blue-800 ">
            <div className="text-3xl tracking-tight">23,450,000</div>
            <span className="text-sm font-medium">원</span>
          </div>
