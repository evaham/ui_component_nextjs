  ...
  return (
    <div className="p-6 rounded-2xl bg-white transition-all">
      ...
      {type === "sales" ? (
        <div className="flex items-center -mt-2 mb-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-zinc-900 tracking-tighter">매출속보 / 랭킹</span>
          </div>
        ...
        <div className="flex items-center -mt-2 mb-2">
          <div className="flex items-center gap-2">
            <div className="w-1.5 h-1.5 bg-[#26499d] rounded-full"></div>
            <span className="font-bold text-zinc-900 tracking-tighter">오늘 우리매장 매출은? (매출액/객수/객단가)</span>
          </div>
          <button className="ml-4 text-sm text-zinc-600 font-medium cursor-pointer tracking-tighter">
            더보기
          </button>
        ...
        <div className="flex items-center -mt-2 mb-2">
          <div className="flex items-center gap-2">
            <div className="w-1.5 h-1.5 bg-[#26499d] rounded-full"></div>
            <span className="font-bold text-zinc-900 tracking-tighter">어제 (7/30) 매출</span>
          </div>
          <button className="ml-4 text-sm text-zinc-600 font-medium cursor-pointer tracking-tighter">
            더보기
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="relative flex flex-col px-4 py-3 bg-[#26499d] rounded-2xl">
          ...
          <div className="flex items-baseline gap-1 font-bold text-white">
            <div className="text-3xl tracking-tighter">23,450,000</div>
        ...
        {/* 전국 200평 이하 */}
        <div className="relative flex flex-col px-4 py-3 border border-zinc-100 rounded-2xl text-zinc-600">
          <div className="text-sm font-bold mb-2 tracking-tighter">전국 200평 이하</div>
          <div className="flex items-baseline gap-1 mb-1 font-bold text-blue-800 ">
            <div className="text-3xl tracking-tighter">1,234,000,000</div>
            <span className="text-sm font-medium">원</span>
          </div>
          <div className="flex gap-1 mt-2 text-sm font-bold text-blue-800 bg-blue-800/5 px-3 py-1 rounded-full self-start">
            <span className="font-medium">객수</span>
            <span className="font-bold">829</span>
          ...
          <div className="absolute top-3 right-3 flex gap-1 text-sm text-zinc-500 font-medium tracking-tighter">
            <span>순위</span>
        ...
        {/* 인천 200평 이하 */}
        <div className="relative flex flex-col px-4 py-3 border border-zinc-100 rounded-2xl text-zinc-600">
          <div className="text-sm font-bold mb-2 tracking-tighter">인천 200평 이하</div>
          <div className="flex items-baseline gap-1 mb-1 font-bold text-blue-800 ">
            <div className="text-3xl tracking-tighter">18,400,000</div>
            <span className="text-sm font-medium">원</span>
          </div>
          <div className="flex gap-1 mt-2 text-sm font-bold text-blue-800 bg-blue-800/5 px-3 py-1 rounded-full self-start">
            <span className="font-medium">객수</span>
        ...
        <div className="relative flex flex-col px-4 py-3 bg-zinc-50 rounded-2xl text-zinc-600">
          <div className="text-sm font-bold mb-2 tracking-tighter">전국평균</div>
          <div className="flex items-baseline gap-1 mb-1 font-bold text-blue-800 ">
            <div className="text-3xl tracking-tighter">1,234,000,000</div>
            <span className="text-sm font-medium">원</span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {/* 우리매장 */}
        <div className="relative flex flex-col px-4 py-3 border border-zinc-100 rounded-2xl text-zinc-600">
          <div className="text-sm font-bold mb-2 tracking-tighter">우리 매출액</div>
          <div className="flex items-baseline gap-1 mb-1 font-bold text-blue-800">
            <div className="text-3xl tracking-tighter">23,450,000</div>
            <span className="text-sm font-medium">원</span>
          </div>
        ...
        <div className="relative flex flex-col px-4 py-3 border border-zinc-100 rounded-2xl text-zinc-600">
          ...
          <div className="absolute top-3 right-3 flex gap-1 text-sm text-zinc-500 font-medium tracking-tighter">
            <span>이전일</span>
            <span className="font-bold text-red-500">- 10.3</span>
            <span className="font-bold">%</span>
          </div>
        </div>
        {/* 전국평균 */}
        <div className="relative flex flex-col px-4 py-3 bg-zinc-50 rounded-2xl text-zinc-600">
          ...
          <div className="flex gap-2 mt-2 text-sm font-bold text-blue-800 bg-blue-800/5 px-3 py-1 rounded-full self-start">
            <span className="font-medium">객수</span>
            <span className="font-bold">829</span>
            <span className="mx-1 text-blue-800/50">/</span>
            <span className="font-medium">객단가</span>
          ...
          <div className="absolute top-3 right-3 flex gap-1 text-sm text-zinc-500 font-medium tracking-tighter">
            <span>이전일</span>
            <span className="font-bold text-red-500">- 18.3</span>
            <span className="font-bold">%</span>
          </div>
        </div>
      </div>
